...
const ru: Dict = {
  ...
  about: {
    ...
    bio: [
      "Двадцать лет занимаюсь ИИ-инженерией, сейчас пишу PhD. Помимо этого веду «Нейронную космологию» — исследовательскую программу о природе сознания и серию из трёх книг вокруг неё: документальную и два романа.",

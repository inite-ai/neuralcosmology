...
These numbers are *testable*. They are measured by the box-counting algorithm: cover the object with a grid at varying scales and count how the number of non-empty cells changes with scale. What you get next is an ordinary log-log plot whose line-slope is the dimension; no mysticism enters anywhere.

...
Panpsychism claims consciousness is a fundamental property of matter, lying at its base rather than arising from its organisation. An atom, a molecule, and a stone all carry it equally — only in a homeopathic dose. The brain is arranged in a way that locally *concentrates* this property to the level we call experience.
...
Φ rises along this scale with the system's degree of integration: close to zero for an atom and a stone alike, slightly higher for a microbe, much higher for a human, and still debated for AI models.

...
Sounds big, I know; but bigness alone is not an argument against — Newton's law of gravitation also sounded big in its time. The only meaningful question is whether the theory makes *testable* predictions. Neural Cosmology already makes a handful — some are being tested now, the rest are in line.

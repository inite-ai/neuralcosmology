...
There are papers trying to apply Ricci flow to neural connectivity graphs: a fashionable and beautiful but still premature move. A mathematical analogy becomes a theory only when it makes predictions you can test.

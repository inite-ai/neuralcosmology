...
The idea is not mine. Carlo Rovelli wrote a book about it (*The Order of Time*, 2017). Julian Barbour, earlier still (*The End of Time*, 1999). Barbour in fact thinks there is no time at all — only a Platonic space of instantaneous configurations of the universe, and "flow" is an illusion. I do not join the extreme position, but it lives in the mainstream and ignoring it would be dishonest.

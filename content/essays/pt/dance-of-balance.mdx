...
Norbert Wiener (MIT, *Cybernetics*, 1948) mostrou que qualquer sistema com retroalimentação negativa se comporta do mesmo jeito: mede o desvio, aplica a correção, volta ao setpoint. A mesma matemática descreve um termostato, um batimento cardíaco, um preço de mercado e a oposição política atuando como estabilizadora do poder.

...
A ideia não é minha. Carlo Rovelli escreveu um livro sobre isso (*The Order of Time*, 2017). Julian Barbour, ainda antes (*The End of Time*, 1999). Barbour, de fato, acha que não há tempo nenhum — só um espaço platônico de configurações instantâneas do universo, e o "fluxo" é ilusão. Não me alinho à posição extrema, mas ela vive no mainstream e ignorá-la seria desonesto.

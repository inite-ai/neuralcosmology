...
O panpsiquismo afirma que a consciência é propriedade fundamental da matéria, presente na sua base e não decorrente da sua organização. Um átomo, uma molécula e uma pedra a carregam por igual — só em dose homeopática. O cérebro está arranjado de um jeito que localmente *concentra* essa propriedade ao nível que chamamos de experiência.
...
Φ cresce ao longo desta escala com o grau de integração do sistema: próximo de zero no átomo e na pedra por igual, um pouco maior no micróbio, muito maior no humano, e ainda em debate para os modelos de IA.

...
Esses números são *testáveis*. São medidos pelo algoritmo de box-counting: cobre-se o objeto com uma grade em várias escalas e conta-se como o número de células não vazias muda com a escala. O que se obtém em seguida é um gráfico log-log comum cuja inclinação da reta é a dimensão; nenhuma mística entra em cena.

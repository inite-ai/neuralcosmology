...
Soa grande, eu sei; mas tamanho por si só não é argumento contra — a gravitação de Newton também soava grande no seu tempo. A única pergunta com sentido é se a teoria faz previsões *testáveis*. A Neural Cosmology já fez algumas — umas estão sendo testadas agora, outras estão na fila.

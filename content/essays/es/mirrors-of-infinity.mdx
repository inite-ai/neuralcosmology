...
Esos números son *testables*. Se miden con el algoritmo de box-counting: se cubre el objeto con una rejilla a distintas escalas y se cuenta cómo cambia el número de celdas no vacías con la escala. Lo que se obtiene después es un gráfico log-log corriente cuya pendiente de recta es la dimensión; ninguna mística entra en juego.
